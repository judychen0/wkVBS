...
with open(remotepath, "r") as filepath:
    ...
    for line in path:
        ...
        script += "mkdir /home/judychen/Draw/chipoutput/"+str(yeardir)+"/OOT/"+str(dirname)+" \n"
        script += "returndir=/home/judychen/Draw/chipoutput/"+str(yeardir)+"/OOT/"+str(dirname)+" \n"
        ...
        script += """/usr/bin/time parallel --progress --jobs 60 'root -l -b -q "xZgOOT.C+(\\\"{1}\\\")"' :::: path.txt  \n"""
