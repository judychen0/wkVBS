...
class TreeReader {
 ...
 public:
   ...
   TreeReader(const char* patt,               const char* treename = "EventTree");
   TreeReader(const char** paths, int npaths, const char* treename = "EventTree");
   TreeReader(std::vector<std::string> paths, const char* treename = "EventTree");
