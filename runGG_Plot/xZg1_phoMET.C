...
void xZg1(char* pathes, Int_t ULsamples){
  //***********************Initialization***********************//
  ...
  for (Long64_t ev = 0; ev < data.GetEntriesFast(); ev++){
	...
	if(pho_sel(cutflow[icat],3) == 1) h_MET_130[icat]->Fill(corrMET, WEIGHT);
	if(pho_sel(cutflow[icat],4) == 1) h_MET_M[icat]->Fill(corrMET, WEIGHT);
	if(pho_sel(cutflow[icat],6) == 1) h_MET_leptonveto[icat]->Fill(corrMET, WEIGHT);
	if(pho_sel(cutflow[icat],7) == 1) h_MET_MET[icat]->Fill(corrMET, WEIGHT);
	if(pho_sel(cutflow[icat],8) == 1) h_MET_dphoMETPhi[icat]->Fill(corrMET, WEIGHT);
	if(pho_sel(cutflow[icat],9) == 1) h_MET_jetveto[icat]->Fill(corrMET, WEIGHT);
	if(pho_sel(cutflow[icat],10) == 1) h_MET_jetpt[icat]->Fill(corrMET, WEIGHT);
	if(pho_sel(cutflow[icat],11) == 1) h_MET_jetjetdEta[icat]->Fill(corrMET, WEIGHT);
	if(pho_sel(cutflow[icat],12) == 1) h_MET_jetjetdPhi[icat]->Fill(corrMET, WEIGHT);
	if(pho_sel(cutflow[icat],13) == 1) h_MET_phojetdR[icat]->Fill(corrMET, WEIGHT);
	if(pho_sel(cutflow[icat],14) == 1) h_MET_ptoverMET[icat]->Fill(corrMET, WEIGHT);
	if(pho_sel(cutflow[icat],15) == 1) h_MET_mindJMETPhi[icat]->Fill(corrMET, WEIGHT);
	if(pho_sel(cutflow[icat],16) == 1) h_MET_dijetMass[icat]->Fill(corrMET, WEIGHT);
