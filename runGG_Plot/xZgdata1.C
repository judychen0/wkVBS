...
void xZgdata1(char* pathes){
  ...
  h_djetMETPhi_Nm1 = new TH1F("h_djetMETPhi_Nm1", "djetMETPhi mindJMETPhi N-1 cut", 16, dphibin);
  h_djetMETPhi_cut = new TH1F("h_djetMETPhi_cut", "djetMETPhi mindJMETPhi cut all", 16, dphibin);
  ...
  h_dPhi_phojet = new TH1F("h_dPhi_phojet", "pho jet dPhi", 16, dphibin);
  h_dr_phojet->Sumw2();
  h_dEta_phojet->Sumw2();
  h_dPhi_phojet->Sumw2();       
