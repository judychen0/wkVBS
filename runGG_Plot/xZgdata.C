...
void xZgdata(char* pathes){
  ...
  for(Int_t j=0; j<2; j++){
    ...
    h_phoEB_pt_ptoverMET[j] = new TH1F(Form("h_phoEB_pt_ptoverMET_%i", j), "pho Pt over MET cut", 18, ptbin);
  ...
  h_phoEB_ptcut_minJMETdPhi_SB = new TH1F("h_phoEB_ptcut_minJmetdPhi_SB", "pho pT in minJMETdPhi SB region", 18, ptbin);
  ...
  h_phoEB_ptcut_minJMETdPhi_SR = new TH1F("h_phoEB_ptcut_minJmetdPhi_SR", "pho pT in minJMETdPhi SR region", 18, ptbin);
