...
void xZg1(char* pathes, Int_t sig){
  ...
  Double_t ptbin[20] = {0, 20, 35, 50, 100, 150, 200};//6 bins, 2016
  ...
  for(Int_t j=0; j<2; j++){
    h_phoEB_pt_210[j] = new TH1F(Form("h_phoEB_pt_210_%i", j), "matched phoEB pt pt200 cut", 6, ptbin);
    h_phoEB_pt_M[j] = new TH1F(Form("h_phoEB_pt_M_%i", j), "matched phoEB pt M IDcut", 6, ptbin);
    h_phoEB_pt_leptonveto[j] = new TH1F(Form("h_phoEB_pt_leptonveto_%i", j), "leptonveto cut", 6, ptbin);
    h_phoEB_pt_MET[j] = new TH1F(Form("h_phoEB_pt_MET_%i", j), "matched phoEB pt MET cut", 6, ptbin);
    h_phoEB_pt_dphoMETPhi[j] = new TH1F(Form("h_phoEB_pt_dphoMETPhi_%i", j), "matched phoEB pt dphoMETPhi cut", 6, ptbin);
    h_phoEB_pt_jetveto[j] = new TH1F(Form("h_phoEB_pt_jetveto_%i", j), Form("h_phoEB_pt_jetveto_%i", j), 6, ptbin);
    h_phoEB_pt_jetpt[j] = new TH1F(Form("h_phoEB_pt_jetpt_%i", j), Form("h_phoEB_pt_jetpt_%i", j), 6, ptbin);  
    h_phoEB_pt_jetjetdEta[j] = new TH1F(Form("h_phoEB_pt_jetjetdEta_%i", j), "jetjet dEta cut", 6, ptbin);
    h_phoEB_pt_jetjetdPhi[j] = new TH1F(Form("h_phoEB_pt_jetjetdPhi_%i", j), "jetjet dPhi cut", 6, ptbin);
    h_phoEB_pt_phojetdR[j] = new TH1F(Form("h_phoEB_pt_phojetdR_%i", j), "phojet dR cut", 6, ptbin);
    h_phoEB_pt_ptoverMET[j] = new TH1F(Form("h_phoEB_pt_ptoverMET_%i", j), "pho Pt over MET cut", 6, ptbin);
    h_phoEB_pt_mindJMETPhi[j] = new TH1F(Form("h_phoEB_pt_mindJMETPhi_%i", j), "mindJMETPhi cut", 6, ptbin);
    h_phoEB_pt_dijetMass[j] = new TH1F(Form("h_phoEB_pt_dijetMass_%i", j), "dijetMass cut", 6, ptbin);
    ...
    h_phoEB_ptcut[j] = new TH1F(Form("h_phoEB_ptcut_%i", j), "phoEB pt cut all pas varbin", 6, ptbin);
  ...
  h_phoEB_ptcut_minJMETdPhi_SB = new TH1F("h_phoEB_ptcut_minJmetdPhi_SB", "pho pT in minJMETdPhi SB region", 6, ptbin);
  ...
  h_phoEB_ptcut_minJMETdPhi_SR = new TH1F("h_phoEB_ptcut_minJmetdPhi_SR", "pho pT in minJMETdPhi SR region", 6, ptbin);
  ...
  h_phoEB_ptcut_ptoverMET_CR_minJMETdPhi_SB = new TH1F("h_phoEB_ptcut_ptoverMET_CR_minJMETdPhi_SB", "", 6, ptbin);
  ...
  h_phoEB_ptcut_ptoverMET_CR = new TH1F("h_phoEB_ptcut_ptoverMET_CR", "", 6, ptbin);
  ...
  h_phoEB_ptcut_ptoverMET_SR_minJMETdPhi_SB = new TH1F("h_phoEB_ptcut_ptoverMET_SR_minJMETdPhi_SB", "", 6, ptbin);
  ...
  h_phoEB_ptcut_ptoverMET_SR = new TH1F("h_phoEB_ptcut_ptoverMET_SR", "", 6, ptbin);
