...
void xZgdata1(char* pathes){
  ...
  h_jetIso_cut = new TH1F("h_jetIso_cut", "jetIso 0.2 cut all", 20, 0, 1);
  h_jetIso_cut->Sumw2();
  ...
  Double_t massbin[20] = {0, 250, 350, 450, 550, 650, 750, 850, 950, 1050, 1150, 1250, 1350, 1450, 1550, 1650, 2000};//16bins
  ...
  h_dijetMass_cut = new TH1F("h_dijetMass_cut", "dijet mass N cut", 16, massbin);
  h_dijetMass_Nm1 = new TH1F("h_dijetMass_Nm1", "dijet mass N-1 cut", 16, massbin);
  ...
  h_jetdR_lead = new TH1F("h_jetdR_lead", "jetdR lead & all small jets", 30, 0, 3);
  h_jetdR_sub = new TH1F("h_jetdR_sub", "jetdR sub & all small jets", 30, 0, 3);
  h_jetdR_lead->Sumw2();
  h_jetdR_sub->Sumw2();
  ...
  h_dijetMass_minJMETdPhi_SB = new TH1F("h_dijetMass_minJMETdPhi_SB", "dijetMass in minJMETdPhi SB region", 16, massbin);
  ...
  h_dijetMass_minJMETdPhi_SR = new TH1F("h_dijetMass_minJMETdPhi_SR", "dijetMass in minJMETdPhi SR region", 16, massbin);
  ...
  h_dijetMass_ptoverMET_CR_minJMETdPhi_SB = new TH1F("h_dijetMass_ptoverMET_CR_minJMETdPhi_SB", "", 16, massbin);
  ...
  h_dijetMass_ptoverMET_CR = new TH1F("h_dijetMass_ptoverMET_CR", "", 16, massbin);
  ...
  h_dijetMass_ptoverMET_SR_minJMETdPhi_SB = new TH1F("h_dijetMass_ptoverMET_SR_minJMETdPhi_SB", "", 16, massbin);
  ...
  h_dijetMass_ptoverMET_SR = new TH1F("h_dijetMass_ptoverMET_SR", "", 16, massbin);
  ...
  for (Long64_t ev = 0; ev < data.GetEntriesFast(); ev++){
    ...
    npfjet				 =	data.GetInt(		"npfjet_corr"		);
    //npfjet_corr				 =	data.GetInt(		"npfjet_corr"		);
    nSMjet				 =	data.GetInt(            "nSMjet"                );
    nVBSjet				 =	data.GetInt(            "nVBSjet"		);
    jetPt				 =	data.GetPtrFloat(	"jetPt_corr"		);
    jetEta				 =	data.GetPtrFloat(	"jetEta_corr"		);
    jetPhi				 =	data.GetPtrFloat(	"jetPhi_corr"		);
    jetEn				 =	data.GetPtrFloat(	"jetEn_corr"			);
    jetIso = data.GetPtrFloat("jetIso");
    nonPUjetid				 =	data.GetPtrInt(		"nonPUjetid"		);
    dijetMass				 =	data.GetDouble(		"dijetMass"		);
    jetID	         =      data.GetPtrInt(		"jetTID"		);
    jetdR_lead = data.GetPtrFloat("jetdR_lead");
    jetdR_sub = data.GetPtrFloat("jetdR_sub");
