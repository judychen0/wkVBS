...
mcdir=/data1/GMET/ana/220728/fall17/mc/

#cp $drawdir/xMerge_GJet.C .; root -l -q "xMerge_GJet.C(2017)"
#cp output_merge_GJet.root $mcdir/GJet
#cp $drawdir/xMerge_VJet.C .; root -l -q "xMerge_VJet.C(2017)"
#cp output_merge_VJet.root $mcdir/VJet
#cp $drawdir/xMerge_VG.C .; root -l -q "xMerge_VG.C(2017)"
...
#cp $drawdir/xMerge_TT.C .; root -l -q "xMerge_TT.C(2017)"
#cp output_merge_TT.root $mcdir/TT

root -l -q "xMerge_GJet.C(2017)"
cp output_merge_GJet.root $mcdir/GJet
root -l -q "xMerge_VJet.C(2017)"
cp output_merge_VJet.root $mcdir/VJet
root -l -q "xMerge_VG.C(2017)"
cp output_merge_VG.root $mcdir/VG
root -l -q "xMerge_monoboson.C(2017)"
cp output_merge_monoBoson.root $mcdir/monoboson
root -l -q "xMerge_diboson.C(2017)"
cp output_merge_diBoson.root $mcdir/diboson
root -l -q "xMerge_triboson.C(2017)"
cp output_merge_triBoson.root $mcdir/triboson
root -l -q "xMerge_TT.C(2017)"
cp output_merge_TT.root $mcdir/TT
rm *.root
