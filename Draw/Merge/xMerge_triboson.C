...
void xMerge_triboson(Int_t year){
  ...
  if(year==2016){
    rootname[0] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220406/summer16/mc/triboson/job_summer16_WWG/output_ggtree.root";
    rootname[1] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220406/summer16/mc/triboson/job_summer16_WZG/output_ggtree.root";
  }
  else if(year==2017){
    rootname[0] = "/wk_cms3/judychen/chip02/output_ana/220715/fall17/mc/triboson/job_fall17_WWG/output_ggtree.root";
    rootname[1] = "/wk_cms3/judychen/chip02/output_ana/220715/fall17/mc/triboson/job_fall17_WZG/output_ggtree.root";
  }
  else if(year==2018){
    rootname[0] = "/wk_cms3/judychen/chip02/output_ana/220715/autumn18/mc/triboson/job_autumn18_WWG/output_ggtree.root";
    rootname[1] = "/wk_cms3/judychen/chip02/output_ana/220715/autumn18/mc/triboson/job_autumn18_WZG/output_ggtree.root";
  }
  ...
  fout->mkdir("ptoverMET_CR_minJMETdPhi_SB");
  fout->cd("ptoverMET_CR_minJMETdPhi_SB");
  ...
  fout->mkdir("ptoverMET_SR_minJMETdPhi_SB");
  fout->cd("ptoverMET_SR_minJMETdPhi_SB");
