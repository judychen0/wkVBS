...
void xMerge_triboson(Int_t year){
  ...
  if(year==2016){
    ...
    rootname[0] = "/wk_cms3/judychen/chip02/output_ana/220728/fall17/mc/triboson/job_fall17_WWG/output_ggtree.root";
    rootname[1] = "/wk_cms3/judychen/chip02/output_ana/220728/fall17/mc/triboson/job_fall17_WZG/output_ggtree.root";
  }
  else if(year==2018){
    rootname[0] = "/wk_cms3/judychen/chip02/output_ana/220728/autumn18/mc/triboson/job_autumn18_WWG/output_ggtree.root";
    rootname[1] = "/wk_cms3/judychen/chip02/output_ana/220728/autumn18/mc/triboson/job_autumn18_WZG/output_ggtree.root";
  }
